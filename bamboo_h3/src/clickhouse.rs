...
pub struct ResultSet {
    ...
    /// the h3 cell containing all data contained in `column_data`. Populated in case this
    /// was fetched during a `Cell Walk`
    pub(crate) containing_index: Option<u64>,
...
impl ResultSet {
    ...
    /// get the h3index of the containing cell in case this resultset was fetched during a
    /// walk
    #[getter]
    fn get_containing_index(&self) -> Option<u64> {
        self.containing_index
    }
